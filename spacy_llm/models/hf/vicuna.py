...
@registry.llm_models("spacy.Vicuna.v1")
def vicuna_hf(
    name: Vicuna.MODEL_NAMES,
    ...
    RETURNS (Callable[[Iterable[str]], Iterable[str]]): Vicuna instance that can execute a set of prompts and return
        the raw responses.
    """
    return Vicuna(name=name, config_init=config_init, config_run=config_run)
